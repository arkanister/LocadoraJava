...
public class frmTabelaFornecedores extends javax.swing.JFrame {
    ...
    public frmTabelaFornecedores() {
        ...
        Object campos[] = {carregando_lista.get(i).getId(),
                            carregando_lista.get(i).getRazao_social(),
                            carregando_lista.get(i).getCnpj(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmTabelaFornecedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmTabelaFornecedores().setVisible(true);
            }
        });
    }
